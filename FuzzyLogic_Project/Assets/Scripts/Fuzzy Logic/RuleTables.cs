...
public static class RuleTables
{
    ...
    private static void InicializarReglas()
    {
        ...
        // Media Distancia
        baseReglas[(int)TagCuriosidad.Nula, (int)TagDistancia.Media, (int)TagMiedo.Relajado] = (int)Accion.RetiradaLenta;
        ...
        baseReglas[(int)TagCuriosidad.Nula, (int)TagDistancia.Lejos, (int)TagMiedo.Cauto] = (int)Accion.RetiradaLenta;
        ...
        // Muy Cerca
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.MuyCerca, (int)TagMiedo.Relajado] = (int)Accion.RetiradaLenta;
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.MuyCerca, (int)TagMiedo.Cauto] = (int)Accion.HuidaRapida;
        ...
        // Cerca
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Cerca, (int)TagMiedo.Relajado] = (int)Accion.RetiradaLenta;
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Cerca, (int)TagMiedo.Cauto] = (int)Accion.RetiradaLenta;
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Cerca, (int)TagMiedo.Alerta] = (int)Accion.HuidaRapida;
        ...
        // Media Distancia
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Media, (int)TagMiedo.Relajado] = (int)Accion.Idle;
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Media, (int)TagMiedo.Cauto] = (int)Accion.RetiradaLenta;
        ...
        // Lejos
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Lejos, (int)TagMiedo.Relajado] = (int)Accion.Idle;
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Lejos, (int)TagMiedo.Cauto] = (int)Accion.Idle;
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.Lejos, (int)TagMiedo.Alerta] = (int)Accion.RetiradaLenta;
        ...
        // Muy Lejos
        baseReglas[(int)TagCuriosidad.Baja, (int)TagDistancia.MuyLejos, (int)TagMiedo.Relajado] = (int)Accion.Idle;
        ...
        baseReglas[(int)TagCuriosidad.Media, (int)TagDistancia.MuyCerca, (int)TagMiedo.Cauto] = (int)Accion.RetiradaLenta;
        baseReglas[(int)TagCuriosidad.Media, (int)TagDistancia.MuyCerca, (int)TagMiedo.Alerta] = (int)Accion.HuidaRapida;
        ...
        baseReglas[(int)TagCuriosidad.Media, (int)TagDistancia.Cerca, (int)TagMiedo.Alerta] = (int)Accion.RetiradaLenta;
        baseReglas[(int)TagCuriosidad.Media, (int)TagDistancia.Cerca, (int)TagMiedo.Asustado] = (int)Accion.HuidaRapida;
        ...
        // Muy Lejos
        baseReglas[(int)TagCuriosidad.Media, (int)TagDistancia.MuyLejos, (int)TagMiedo.Relajado] = (int)Accion.Idle;
        baseReglas[(int)TagCuriosidad.Media, (int)TagDistancia.MuyLejos, (int)TagMiedo.Cauto] = (int)Accion.Idle;
        ...
        // Muy Cerca
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.MuyCerca, (int)TagMiedo.Relajado] = (int)Accion.AproxLenta;
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.MuyCerca, (int)TagMiedo.Cauto] = (int)Accion.HuidaRapida;
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.MuyCerca, (int)TagMiedo.Alerta] = (int)Accion.HuidaRapida;
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.MuyCerca, (int)TagMiedo.Asustado] = (int)Accion.HuidaRapida;
        ...
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.Cerca, (int)TagMiedo.Alerta] = (int)Accion.HuidaRapida;
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.Cerca, (int)TagMiedo.Asustado] = (int)Accion.HuidaRapida;
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.Cerca, (int)TagMiedo.Panico] = (int)Accion.HuidaRapida;
        ...
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.Media, (int)TagMiedo.Asustado] = (int)Accion.HuidaRapida;
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.Media, (int)TagMiedo.Panico] = (int)Accion.HuidaRapida;
        ...
        baseReglas[(int)TagCuriosidad.Alta, (int)TagDistancia.MuyLejos, (int)TagMiedo.Alerta] = (int)Accion.Idle;
        ...
        // Muy Cerca
        baseReglas[(int)TagCuriosidad.Extrema, (int)TagDistancia.MuyCerca, (int)TagMiedo.Relajado] = (int)Accion.AproxRapida;
        baseReglas[(int)TagCuriosidad.Extrema, (int)TagDistancia.MuyCerca, (int)TagMiedo.Cauto] = (int)Accion.AproxLenta;
        baseReglas[(int)TagCuriosidad.Extrema, (int)TagDistancia.MuyCerca, (int)TagMiedo.Alerta] = (int)Accion.Idle;
        baseReglas[(int)TagCuriosidad.Extrema, (int)TagDistancia.MuyCerca, (int)TagMiedo.Asustado] = (int)Accion.RetiradaLenta;
        baseReglas[(int)TagCuriosidad.Extrema, (int)TagDistancia.MuyCerca, (int)TagMiedo.Panico] = (int)Accion.HuidaRapida;
